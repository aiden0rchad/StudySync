        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20 gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
              ...
              {/* Unified Tools & Integrations Dock */}
              <div className="flex items-center bg-slate-100/70 dark:bg-slate-800/50 p-1 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 gap-0.5">
                ...
                <div className="relative">
                  <button
                    ...
                    title="Calendar, Canvas, Discord & Automations"
                  >
                  ...
                  {showSyncMenu && (
                    <>
                      ...
                      <div className="absolute -right-20 sm:right-0 mt-2 w-64 bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 py-2 z-50 animate-in fade-in zoom-in-95 duration-100">
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-[11px] text-slate-400 truncate">Webhooks, micro-steps & auto-nudges</div>
                          </div>
                        </button>
                ...
                <div className="h-4 w-px bg-slate-200 dark:bg-slate-700/80 mx-0.5" />
