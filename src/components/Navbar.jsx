...
export default function Navbar({ 
  ...
  return (
    <>
      {/* ===================== TOP HEADER ===================== */}
      <header className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-lg border-b border-slate-200/80 dark:border-slate-800/80 sticky top-0 z-30 transition-colors duration-150">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20 gap-3 sm:gap-4">
            
            {/* Left: Brand Identity */}
            <div className="flex items-center gap-3 shrink-0">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-tr from-indigo-600 via-indigo-500 to-violet-600 text-white flex items-center justify-center shadow-md shadow-indigo-500/20 dark:shadow-none transition-transform hover:scale-105">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="hidden xl:inline-block text-[10px] font-bold uppercase tracking-wider bg-indigo-50 dark:bg-indigo-950/70 text-indigo-600 dark:text-indigo-400 px-2 py-0.5 rounded-full border border-indigo-200/60 dark:border-indigo-800/60">
                  Student
                </span>
              </div>
            </div>
            ...
            <nav className="hidden md:flex items-center p-1.5 bg-slate-100/70 dark:bg-slate-800/50 backdrop-blur-xs rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-2xs gap-1">
              {tabs.map((tab) => {
                const Icon = tab.icon;
                ...
                return (
                  <button
                    ...
                    className={`relative flex items-center gap-2 px-3.5 py-2 text-xs font-semibold rounded-xl transition-all duration-150 ${
                      isActive
                        ? 'bg-white dark:bg-slate-900 text-indigo-600 dark:text-indigo-400 shadow-xs'
                        : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-white/50 dark:hover:bg-slate-800/60'
                    }`}
                  >
            ...
            <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
              ...
              {/* Integrations Dock (Sync Hub & Discord Coach) */}
              <div className="flex items-center bg-slate-100/70 dark:bg-slate-800/50 p-1 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 gap-0.5">
                    ...
                    <>
                      ...
                      <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 py-2 z-50 animate-in fade-in zoom-in-95 duration-100">
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-3.5 py-2.5 text-xs font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 text-left transition-colors"
                        >
                          <div className="w-7 h-7 rounded-xl bg-rose-100 dark:bg-rose-950/60 text-rose-600 dark:text-rose-400 flex items-center justify-center shrink-0">
                          ...
                          <div>
                            <div className="font-semibold text-slate-900 dark:text-white">Canvas LMS Sync & Grades</div>
                            <div className="text-[11px] text-slate-400">Classes, homework & live GPA</div>
                          </div>
                        </button>
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-3.5 py-2.5 text-xs font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 text-left transition-colors"
                        >
                          <div className="w-7 h-7 rounded-xl bg-indigo-100 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 flex items-center justify-center shrink-0">
                        ...
                        >
                          <div className="w-7 h-7 rounded-xl bg-[#5865F2]/15 dark:bg-[#5865F2]/25 text-[#5865F2] flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                ...
                <button
                  ...
                  className="hidden md:flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-xl text-slate-600 dark:text-slate-300 hover:text-[#5865F2] dark:hover:text-[#7983f5] hover:bg-white/60 dark:hover:bg-slate-800/60 transition-all active:scale-95"
              ...
              <div className="relative hidden sm:block">
                <div className="inline-flex rounded-2xl shadow-sm shadow-indigo-500/15 overflow-hidden border border-indigo-600/90 dark:border-indigo-500/90">
                  <button
                    onClick={onAddHomework}
                    className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="px-2 py-2 text-white bg-indigo-600 hover:bg-indigo-700 border-l border-indigo-500/80 transition-colors"
              ...
              >
                ...
                <div className="hidden lg:flex items-center gap-2 pl-2 border-l border-slate-300/60 dark:border-slate-700/60">
              ...
              <div className="flex items-center bg-slate-100/70 dark:bg-slate-800/50 p-1 rounded-2xl border border-slate-200/60 dark:border-slate-700/60 gap-0.5">
                ...
                <button
                  ...
                  className={`w-8 h-8 rounded-xl flex items-center justify-center text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-white dark:hover:bg-slate-900 transition-all shadow-none hover:shadow-xs ${
                      ...
                      <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 py-1.5 z-50 animate-in fade-in zoom-in-95 duration-100">
                        ...
                        <div className="px-3.5 py-2 border-b border-slate-100 dark:border-slate-800">
                          ...
                          <select
                            ...
                            className="w-full text-xs bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-1.5 text-slate-700 dark:text-slate-200"
                          >
